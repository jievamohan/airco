...
class SettingsSeeder extends Seeder
{
    ...
    private const DEFINITIONS = [
        ...
        ['key' => 'agent.workflow.follow_up_immediately', 'group' => 'werking', 'type' => 'bool', 'label' => 'Direct opvolgen (demostand)', 'description' => 'Belt meteen bij binnenkomst van een aanvraag en negeert het belvenster, ook \'s nachts. Bedoeld om de keten te laten zien; zet hem daarna weer uit, anders worden echte klanten buiten de tijden gebeld.'],
