...
>
    ...
    <x-mail.text>
        Bedankt voor het prettige gesprek. Hieronder staat de offerte zoals we die hebben
        besproken. De volledige specificatie zit als pdf bij deze mail.
    </x-mail.text>
    ...
    <x-mail.text muted small>
        Deze offerte is opgesteld op basis van de gegevens die u heeft doorgegeven. Wijkt de
        situatie op locatie af — bijvoorbeeld in leidinglengte, bereikbaarheid van de gevel of
        de beschikbare elektragroep — dan stemmen we een aangepaste prijs met u af voordat het
        werk begint.
    </x-mail.text>
</x-mail.layout>
