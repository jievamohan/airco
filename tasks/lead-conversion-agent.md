...
scope_in:
  ...
  - "ElevenLabs Conversational AI uitbelintegratie (kwalificatie + conversie) incl. post-call webhook"
  - "Offerte genereren en mailen direct na kwalificatiegesprek"
...
acceptance:
  ...
  - "Na een beantwoord kwalificatiegesprek wordt binnen dezelfde flow een offertemail verstuurd"
  - "60 minuten na de offerte wordt automatisch een conversiegesprek ingepland"
  - "Bij akkoord wordt een agenda-afspraak aangemaakt bij de geconfigureerde provider"
