...
See [`references/KEYWORDS.md`](references/KEYWORDS.md) for vocabulary; produce **DESIGN SYSTEM (REQUIRED)** + **Page Structure** blocks as in [`SKILL.md`](SKILL.md) § Output contract.
